	...
	public static WebDriver toWebDriver(int browser) throws Exception {
		...
		case 2:// escolhendo o chrome
			try {
				...
				proxy.setHttpProxy("http://10.1.11.138:8080");
				proxy.setFtpProxy("http://10.1.11.138:8080");
				proxy.setSocksUsername("marilia.prime");
	            proxy.setSocksPassword("!MG7694216");
				String PROXY = "http://10.1.11.138:8080";
				String proxyAuth= "marilia.prime:!MG7694216";
				//WebDriverManager.chromedriver().driverVersion("83").setup();
