...
@CucumberOptions(features = "src/test/resources/functionalTests/",tags="@cadastro", glue = "", plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/Reports/report.html" }, monochrome = true)
